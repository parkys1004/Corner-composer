      ...
      {isOpen && (
        <div className="fixed inset-0 z-[200] flex items-center justify-center p-4">
            ...
            <motion.div
                ...
                className="relative w-[90%] sm:w-full max-w-[480px] bg-[#1e293b] rounded-2xl sm:rounded-3xl overflow-hidden border border-white/10 shadow-[0_0_60px_rgba(99,102,241,0.5)]"
            >
                ...
                <div className="relative p-5 sm:p-8 text-center">
                    <button 
                        onClick={() => handleClose(false)} 
                        className="absolute top-3 right-3 sm:top-4 sm:right-4 text-slate-400 hover:text-white transition-colors p-2 rounded-full hover:bg-white/10"
                    >
                        <X className="w-5 h-5" />
                    </button>
                    ...
                    >
                        <div className="bg-gradient-to-r from-yellow-400 to-orange-500 text-black font-extrabold text-xs sm:text-sm px-3 py-1 sm:px-4 sm:py-1.5 rounded-full shadow-lg mb-4 sm:mb-6 transform -rotate-2 border-2 border-white/20">
                            🎉 출시 기념 50% ↓
                        </div>
                    </motion.div>
                    ...
                    <div className="space-y-1 sm:space-y-2 mb-5 sm:mb-8">
                        <h2 className="text-lg sm:text-2xl font-bold text-white leading-snug break-keep">
                            Suno AI 음원 자료 + <br/>
                    ...
                    {/* Visual Icon Group */}
                    <div className="flex justify-center gap-4 sm:gap-6 mb-5 sm:mb-8">
                        <div className="bg-white/5 p-2 sm:p-3 rounded-xl sm:rounded-2xl border border-white/10">
                    ...
                    {/* Offer Box */}
                    <div className="bg-[#0f172a] rounded-xl sm:rounded-2xl p-4 sm:p-5 border border-indigo-500/30 relative mb-5 sm:mb-6 group hover:border-indigo-500/60 transition-colors">
                        ...
                        <div className="flex items-center justify-center gap-2 sm:gap-3 mt-1">
                            <div className="flex flex-col items-end opacity-50">
                                <span className="text-xs sm:text-sm font-medium text-slate-400 line-through">30,000원</span>
                            </div>
                            <ArrowRight className="w-4 h-4 sm:w-5 sm:h-5 text-slate-500" />
                            <div className="flex flex-col items-start">
                                <span className="text-2xl sm:text-3xl font-extrabold text-yellow-400 drop-shadow-sm">15,000<span className="text-base sm:text-lg font-bold">원</span></span>
                    ...
                    {/* Footer Date */}
                    <div className="inline-flex items-center gap-2 text-red-300 bg-red-500/10 px-3 py-1.5 rounded-lg text-xs sm:text-sm font-semibold mb-5 sm:mb-8 border border-red-500/20">
                    ...
                    <a 
                        ...
                        target="_blank"
                        className="block w-full py-3 sm:py-4 bg-gradient-to-r from-indigo-600 to-purple-600 hover:from-indigo-500 hover:to-purple-500 text-white font-bold text-base sm:text-lg rounded-xl shadow-lg shadow-indigo-500/30 transition-all hover:scale-[1.02] active:scale-[0.98] mb-3 sm:mb-4 relative overflow-hidden group"
                    >
